    ...
    public SecurityFilterChain filterChain(final HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable()) // Deshabilitar CSRF
            ...
            .authorizeHttpRequests(authz -> authz
                // Recursos públicos
                .requestMatchers("/","/eula", "/inicio","/home","/series","/peliculas","/documentales", "/login", "/signin", "/css/**", "/img/**","/js/**","/static/**","/modo","/usuarios","/configuracion","/suscripciones", "/suscripciones/tipos").permitAll()
                // Acceso según roles
